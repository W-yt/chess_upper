    ...
    def piece_save(self, piece_roi_size, distance_edge, save_dir):
        ...
        if self.circles is not None:
            ...
            for circle in circles[0]:
                ...
                # piece_save_b, piece_save_g, piece_save_r = cv.split(piece_save)
                # piece_save = piece_save_g
                cv.imshow("piece_save_g", piece_save)
    ...
    def piece_predict(self, piece_roi_size, distance_edge):
        ...
        if self.circles is not None:
            ...
            for circle in circles[0]:
                ...
                print("predict result : ", predict_type, "\t", "predict_probability : ", predict_probability)
